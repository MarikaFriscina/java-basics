...
public class BookStore {
	...
	public static void main(String[] args) {
	    ...
	    // descrizione
	    String descrizione = "Quotidianamente, senza pensarci troppo, con i nostri strumenti tecnologici (potenti computer o eleganti dispositivi mobili), facciamo cose che possiamo definire straordinarie";
